...
### ```Note✨: I have another amazing project on``` [end-to-end-encrypted-chat-application](https://github.com/VishalGupta/mern-chat) ```using Next.js, Prisma, Postgresql, Express, Socket.io.```
